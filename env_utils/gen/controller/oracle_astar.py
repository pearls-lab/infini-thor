...
# from gen.controller.oracle import OracleAgent
import constants
...
from controller.oracle import OracleAgent
...
class OracleAStarAgent(OracleAgent):
    ...
    def setup_navigator(self):
        ...
        points_source = os.path.join(gen.__path__[0], 'layouts/FloorPlan%s-openable.json' % scene_num)
        ...
        #self.navigator = SemanticMapPlannerAgent(thread_id=0, game_state=game_state)
